...
public class Registreren extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           k.setAdres(request.getParameter("Adres"));
           k.setPostcode(Integer.parseInt(request.getParameter("Postcode")));
           k.setStad(request.getParameter("Stad"));           
           k.setTelefoonnummer(Integer.parseInt(request.getParameter("Telefoonnummer")));
           k.setEmail(request.getParameter("Emailadres"));
           k.setWachtwoord(request.getParameter("Wachtwoord"));
